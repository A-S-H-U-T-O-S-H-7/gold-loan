...
export const userKycService = {
    ...
    createUserKyc: async (data) => {
        try {
            ...
            formData.append("alt_mobile", data.alternatePhone || "");
            formData.append("email", data.email || "");
            formData.append("pan_no", data.panNumber || "");
            formData.append("aadhar_no", data.aadharNumber || "");
            
            // Current Address
            formData.append("curr_house_no", data.currentAddress?.houseNo || "");
            formData.append("curr_address", data.currentAddress?.addressLine1 || "");
            if (data.currentAddress?.addressLine2) {
                formData.append("curr_address2", data.currentAddress.addressLine2);
            }
            formData.append("curr_state", data.currentAddress?.state || "");
            formData.append("curr_city", data.currentAddress?.city || "");
            formData.append("curr_pincode", data.currentAddress?.pincode || "");
            
            // Permanent Address
            if (data.sameAsCurrent) {
                formData.append("per_house_no", data.currentAddress?.houseNo || "");
                formData.append("per_address", data.currentAddress?.addressLine1 || "");
                if (data.currentAddress?.addressLine2) {
                    formData.append("per_address2", data.currentAddress.addressLine2);
                }
                formData.append("per_state", data.currentAddress?.state || "");
                formData.append("per_city", data.currentAddress?.city || "");
                formData.append("per_pincode", data.currentAddress?.pincode || "");
            } else {
                formData.append("per_house_no", data.permanentAddress?.houseNo || "");
                formData.append("per_address", data.permanentAddress?.addressLine1 || "");
                if (data.permanentAddress?.addressLine2) {
                    formData.append("per_address2", data.permanentAddress.addressLine2);
                }
                formData.append("per_state", data.permanentAddress?.state || "");
                formData.append("per_city", data.permanentAddress?.city || "");
                formData.append("per_pincode", data.permanentAddress?.pincode || "");
            }
            
            // Bank Details
            formData.append("bank_name", data.bankName || "");
            formData.append("branch_name", data.bankBranch || "");
            formData.append("account_type", data.accountType || "Saving");
            ...
            // Nominee Details
            formData.append("nominee_name", data.nominee?.name || "");
            formData.append("nominee_relation", data.nominee?.relation || "");
            formData.append("nominee_dob", data.nominee?.dob || "");
            formData.append("nominee_gender", data.nominee?.gender || "");
            formData.append("nominee_mobile", data.nominee?.mobile || "");
            formData.append("nominee_email", data.nominee?.email || "");
            formData.append("nominee_aadhar_no", data.nominee?.aadharNumber || "");
            formData.append("nominee_pan_no", data.nominee?.panNumber || "");
    ...
    updateUserKyc: async (id, data) => {
        try {
            ...
            const payload = {
                ...
                account_type: data.accountType || "Saving",
