      ...
      <div className="container mx-auto px-4 py-4 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 animate-slideInFromLeft">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              <div className="animate-slideInFromLeft bg-white p-2  rounded-xl shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="relative w-8 h-8 md:w-10 md:h-10 mx-auto mb-2">
              ...
              <div className="animate-slideInFromLeft delay-100 bg-white p-2 rounded-xl shadow-lg border border-green-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="relative w-8 h-8 md:w-10 md:h-10 mx-auto mb-2">
              ...
              <div className="animate-slideInFromLeft delay-200 bg-white p-2 rounded-xl shadow-lg border border-amber-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="relative w-8 h-8 md:w-10 md:h-10 mx-auto mb-2">
              ...
              <div className="animate-slideInFromLeft delay-300 bg-white p-2 rounded-xl shadow-lg border border-purple-200 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <div className="relative w-8 h-8 md:w-10 md:h-10 mx-auto mb-2">
            ...
            <div className="mb-6 md:mb-8 animate-slideInFromLeft delay-400">
              <Link
                href="/apply"
                className="inline-block bg-linear-to-r from-amber-500 to-amber-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-2xl transition-all hover:scale-105 text-center shadow-xl w-full md:w-auto hover:from-amber-600 hover:to-amber-700 active:scale-95"
              >
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 md:gap-6 text-sm text-gray-600 animate-slideInFromRight">
              <div className="flex items-center bg-white px-4 py-3 rounded-xl shadow-md border border-green-200 hover:shadow-lg transition-shadow hover:border-green-300">
                <CheckCircle className="h-5 w-5 text-green-600 mr-3 flex-shrink-0" />
                <span className="font-semibold">No Prepayment Charges</span>
              </div>
              <div className="flex items-center bg-white px-4 py-3 rounded-xl shadow-md border border-blue-200 hover:shadow-lg transition-shadow hover:border-blue-300">
                <CheckCircle className="h-5 w-5 text-blue-600 mr-3 flex-shrink-0" />
                <span className="font-semibold">No Hidden Fees</span>
              </div>
              <div className="flex items-center bg-white px-4 py-3 rounded-xl shadow-md border border-amber-200 hover:shadow-lg transition-shadow hover:border-amber-300">
